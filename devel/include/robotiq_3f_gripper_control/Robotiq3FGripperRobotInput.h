// Generated by gencpp from file robotiq_3f_gripper_control/Robotiq3FGripperRobotInput.msg
// DO NOT EDIT!


#ifndef ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTINPUT_H
#define ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTINPUT_H
...
struct Robotiq3FGripperRobotInput_
{
  ...
  typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> const> ConstPtr;

}; // struct Robotiq3FGripperRobotInput_

typedef ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<std::allocator<void> > Robotiq3FGripperRobotInput;

typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput > Robotiq3FGripperRobotInputPtr;
typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput const> Robotiq3FGripperRobotInputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator1> & lhs, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4d0701156e580a42ULL;
  static const uint64_t static_value2 = 0x0c48833f57bc83f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotInput_<ContainerAllocator>& v)
  {
    s << indent << "gACT: ";
...
#endif // ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTINPUT_H
