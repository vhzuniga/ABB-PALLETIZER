// Generated by gencpp from file robotiq_3f_gripper_control/Robotiq3FGripperRobotOutput.msg
// DO NOT EDIT!


#ifndef ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTOUTPUT_H
#define ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTOUTPUT_H
...
struct Robotiq3FGripperRobotOutput_
{
  ...
  typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> const> ConstPtr;

}; // struct Robotiq3FGripperRobotOutput_

typedef ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<std::allocator<void> > Robotiq3FGripperRobotOutput;

typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput > Robotiq3FGripperRobotOutputPtr;
typedef boost::shared_ptr< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput const> Robotiq3FGripperRobotOutputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator1> & lhs, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x31ba91390a569c66ULL;
  static const uint64_t static_value2 = 0x9af204c3d006a806ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotiq_3f_gripper_control::Robotiq3FGripperRobotOutput_<ContainerAllocator>& v)
  {
    s << indent << "rACT: ";
...
#endif // ROBOTIQ_3F_GRIPPER_CONTROL_MESSAGE_ROBOTIQ3FGRIPPERROBOTOUTPUT_H
